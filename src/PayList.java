...
public class PayList extends Frame {
    String userPosition;
    String userName;
    String idEmployees;
    JTable table;
    ...
    PayList(String UserPosition, String UserName, String idEmployees) {
        ...
        String[] columnNames = {"ID", "ID Rent", "Total Price", "Status", "Method"};
    ...
    private void loadTableData() {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/projekgui", "root", "");
             ...
             ResultSet rs = stmt.executeQuery("SELECT * FROM payments ORDER BY FIELD(status, 'waiting', 'paid')")) {
            
            while (rs.next()) {
                model.addRow(new Object[]{
                    rs.getInt("id_payment"),
                    rs.getString("id_rent"),
